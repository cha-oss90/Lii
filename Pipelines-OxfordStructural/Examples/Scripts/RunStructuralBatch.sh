...
# specify the data
StudyFolder=/project/2422119.01/data
#SubjList="S01 S02 S03" # "S01 S02 S03 S04"
SubjList="sub-003" # "S01 S02 S03 S04" $1
#Scanner="3T"

# specify the task
Task="CLEAN" # "RENAME" "PRE" "FREE" "POST" "CLEAN" $ $2

# specify the batch scripts folder
BatchFolder=/project/2422119.01/scripts/Pipelines-OxfordStructural/Examples/Scripts
